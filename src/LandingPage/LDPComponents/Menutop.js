...
import { Button, Form, Input, InputNumber, message, Upload, notification, Radio, Modal, Row, Typography } from 'antd';
...
const Menutop = () => {
    ...
    return (
        <>
            ...
            <Link className="menutab" to={'/webtuyendungmindX/admin/dot-tuyen-dung'} style={{ color: "white", fontSize: 18 }} > admin</Link>
            <Button
                className="btn-modal"
                type="primary"
                onClick={showModal}>
